...
const MOCK = {
  ...
  // Hourly consumption patterns — multipliers (avg ≈ 1.0)
  consumptionPatterns: {
    residential: [
      0.50, 0.42, 0.38, 0.35, 0.38, 0.52,
      0.78, 1.20, 1.45, 1.35, 1.25, 1.18,
      1.28, 1.18, 1.12, 1.15, 1.22, 1.38,
      1.52, 1.55, 1.42, 1.25, 1.05, 0.78
    ],
    commercial: [
      0.20, 0.15, 0.12, 0.10, 0.12, 0.20,
      0.45, 0.82, 1.45, 1.62, 1.65, 1.58,
      1.42, 1.55, 1.62, 1.58, 1.48, 1.22,
      0.92, 0.68, 0.48, 0.38, 0.30, 0.24
    ],
    industrial: [
      0.80, 0.75, 0.72, 0.70, 0.72, 0.78,
      0.92, 1.12, 1.35, 1.40, 1.38, 1.35,
      1.25, 1.35, 1.38, 1.40, 1.35, 1.22,
      1.05, 0.95, 0.88, 0.85, 0.83, 0.82
    ],
    mixed: [
      0.45, 0.38, 0.35, 0.33, 0.35, 0.48,
      0.70, 1.10, 1.40, 1.38, 1.30, 1.25,
      1.30, 1.25, 1.22, 1.25, 1.28, 1.35,
      1.40, 1.42, 1.30, 1.10, 0.88, 0.65
    ]
  },
